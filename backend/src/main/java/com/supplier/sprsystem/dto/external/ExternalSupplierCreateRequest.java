...
public class ExternalSupplierCreateRequest {
    ...
    @NotBlank(message = "Category name or ID is required")
    private String categoryName;

    private String status = "ACTIVE";

    public ExternalSupplierCreateRequest() {
    }

    public ExternalSupplierCreateRequest(String supplierCode, String name, String contactPerson,
